function [ttr, ttr_grad, g, dataV] = dubins_dubins_collision(d, speed, safetyTime, visualize)
%
...
%--AS IN TUTORIAL----------------------------------------------------------
% Problem Parameters.
uThetaMax = 3; % uThetaMax: maximum angular velocity \omega.
uVMax = pi/10; % uVMax: maximum car parallel acceleration.
