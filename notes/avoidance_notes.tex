...
The collision radius was $c_{r}=2m$, the speed and force limit are
$10\left[m/s\right]$ and $3\left[m/s^{2}\right]$ respectively and
$\sqrt{5/2}\text{m/\ensuremath{s^{2}}}$ the prefered distance
...
\begin{align*}
\underset{u}{\max}\,\underset{d}{\min}\left\{ -\left(\nabla\phi\left(z\right)\right)^{\top}f\left(z,u,d\right)-1\right\}  & =\underset{u}{\max}\,\underset{d}{\min}\left\{ -\frac{\partial\phi}{\partial p_{x}}v_{x}-\frac{\partial\phi}{\partial v_{x}}\left(u_{x}-d_{x}\right)-\frac{\partial\phi}{\partial p_{y}}v_{y}-\frac{\partial\phi}{\partial v_{y}}\left(u_{y}-d_{y}\right)-1\right\} \\
 & =\qquad-\left(\frac{\partial\phi}{\partial p_{x}}v_{x}+\frac{\partial\phi}{\partial p_{y}}v_{y}\right)-1\\
...
$\frac{-\left(p_{x}v_{x}+p_{y}v_{y}\right)-\sqrt{\left(p_{x}v_{x}+p_{y}v_{y}\right)^{2}-\left(v_{x}^{2}+v_{y}^{2}\right)\left(p_{x}^{2}+p_{y}^{2}-c_{r}^{2}\right)}}{\left(v_{x}^{2}+v_{y}^{2}\right)}$
